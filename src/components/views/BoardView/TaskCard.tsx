...
export function TaskCard({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`task-card group rounded-lg border border-gray-200 bg-white px-4 py-2 shadow-sm transition-all hover:shadow-md dark:border-slate-700 dark:bg-slate-800 ${
