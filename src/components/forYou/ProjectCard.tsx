...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <div
      ...
      onClick={handleClick}
      className="group relative w-full cursor-pointer overflow-hidden rounded-xl border border-gray-200 bg-white transition-all duration-300 ease-out hover:shadow-xl md:min-w-72 dark:border-slate-700 dark:bg-slate-800"
    >
      ...
      <div className="relative flex flex-col gap-5 p-5">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex min-w-0 flex-1 items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <h3 className="truncate text-base leading-tight font-medium text-gray-900 dark:text-slate-100">
                {project.name}
              </h3>
        ...
        <div>
          <button
            ...
            className="group/btn flex w-full items-center gap-2.5 rounded-lg p-1 pb-[-0.5rem] transition-colors duration-200 hover:bg-gray-50 dark:hover:bg-slate-700/50"
          >
            <Avatar.Group
              max={{
                count: 3,
