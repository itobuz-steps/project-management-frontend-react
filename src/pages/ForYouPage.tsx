...
export function ForYouPage() {
  return (
    ...
    >
      <div className="flex flex-col gap-4 rounded-lg bg-gray-50 p-3 inset-shadow-sm md:p-4">
        <div className="flex items-center justify-between border-b border-b-gray-400 bg-clip-text pb-2 text-xl font-semibold text-black sm:text-2xl">
